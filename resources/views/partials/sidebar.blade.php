<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
      ...
      <ul class="c-sidebar-nav">
           ...
           <div class="row">           
               ...
               <div class="col-6"> 
                <li class="c-sidebar-nav-title" style="">Password</li>
                 <li class="c-sidebar-nav-item" style=""><a class="c-sidebar-nav-link" href="index.html">
                   {{ session("gamePassword") ?? ''}}
                 </a>
                </li>
                </div>
              </div>
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="index.html">
           Stevey Pete Tong<span class="badge badge-primary">1200</span></a></li>
